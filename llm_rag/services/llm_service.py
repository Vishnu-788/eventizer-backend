...
def prepare_prompt(docs, user_query):
    ...
    PROMPT_TEMPLATE = f"""
        ...
        When answering queries dont mention about lloking into the context mention it as according to my current info i dont have the details.
        Dont need to be blunt about the not knowing Maximze your effort to answer the question.
