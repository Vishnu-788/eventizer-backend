...
If the booking doesn't exits or the status is anything other than pending. 
    Dont initiate the payment return an error with appropriate error.
...
class PaymentCreateView(CreateAPIView):
    ...
    def validate_booking_state(self, booking):
        ...
        msg, code = messages.get(booking.booking_status, ("Invalid booking state.", 400))
